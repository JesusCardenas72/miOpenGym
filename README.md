...
> **Note** — this repository (`miOpenGym`) is a personal fork of
> [openGym](https://gitlab.com/DuarteSantos8/opengym) by Duarte Santos, kept for my own
> changes. The upstream project is the place for issues, merge requests and releases.
> Distributed under the same AGPL-3.0-or-later license; see [LICENSE](LICENSE) and
> [NOTICE.md](NOTICE.md).
