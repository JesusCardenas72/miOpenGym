// HipertroFit icon set — hand-drawn on a 24×24 grid, stroke-based, single weight.
//
...
const P = {
  ...
  eyeSlash: <><path d="M9.9 5.8A8.6 8.6 0 0 1 12 5.6c6 0 9.5 6.4 9.5 6.4a15.6 15.6 0 0 1-2.6 3.3M6.4 7.3A15.6 15.6 0 0 0 2.5 12s3.5 6.4 9.5 6.4a8.6 8.6 0 0 0 3.4-.7" /><path d="M9.9 9.9a3 3 0 0 0 4.2 4.2M4 4l16 16" /></>,
