...
export default {
  ...
  'Last': 'Última',
  'Use the suggested weight and reps': 'Usar el peso y las reps sugeridos',
  'Add set — {0} to do': 'Añadir serie — {0} en total',
  ...
  "This browser doesn't support passkeys — you can still use HipertroFit locally on this device.": 'Este navegador no admite passkeys — aun así puedes usar HipertroFit localmente en este dispositivo.',
  ...
  'Sounds': 'Sonidos',
  'Rest between exercises': 'Descanso entre ejercicios',
  'Rest between exercises (this workout)': 'Descanso entre ejercicios (este entreno)',
  'Same as between sets': 'Igual que entre series',
  'App setting': 'Ajuste de la app',
  'Between exercises · {0}': 'Entre ejercicios · {0}',
  'like sets': 'como series',
  'Rest-end sound': 'Sonido de fin de descanso',
  'Boxing bell': 'Campana de boxeo',
  'Tap to preview': 'Toca para escucharlo',
  'Choose audio file': 'Elegir archivo de audio',
  'Use the default bell': 'Usar la campana por defecto',
  'Sound updated': 'Sonido actualizado',
  'Default bell restored': 'Campana por defecto restaurada',
  'That file isn’t an audio file.': 'Ese archivo no es de audio.',
  'That file is too big — up to {0} MB.': 'El archivo es demasiado grande — máximo {0} MB.',
  'That sound is too long — up to {0} seconds.': 'El sonido es demasiado largo — máximo {0} segundos.',
  'Couldn’t read that audio file.': 'No se pudo leer ese archivo de audio.',
  'Couldn’t save the sound on this device.': 'No se pudo guardar el sonido en este dispositivo.',
  'Stored on this device only. Up to {0} seconds — it plays so that it ends exactly when the rest does.': 'Se guarda solo en este dispositivo. Máximo {0} segundos — suena de forma que termina justo cuando acaba el descanso.',
  ...
  'Saves a dated copy after finishing a workout or editing a routine. One file per day, overwritten as the day goes on.': 'Guarda una copia fechada al terminar un entrenamiento o editar una rutina. Un archivo por día, que se sobrescribe a lo largo del día.',
  'Backup folder': 'Carpeta de copias',
  'Documents': 'Documentos',
  'Choose where the copies are written. Google Drive cannot be picked directly; pick a folder a sync app mirrors to Drive.': 'Elige dónde se escriben las copias. Google Drive no se puede seleccionar directamente: elige una carpeta que una app de sincronización replique en Drive.',
  'Sync this folder to Google Drive with an app like Autosync or FolderSync — Drive itself cannot be picked here.': 'Sincroniza esta carpeta con Google Drive usando una app como Autosync o FolderSync — Drive no se puede seleccionar aquí.',
  'Backups will be saved to “{0}”': 'Las copias se guardarán en «{0}»',
  'Use default folder': 'Usar la carpeta por defecto',
  'Use the default folder again?': '¿Volver a la carpeta por defecto?',
  'New backups go back to the app’s Documents folder. Copies already in the folder you chose are left alone.': 'Las nuevas copias volverán a la carpeta Documentos de la app. Las copias que ya están en la carpeta elegida no se tocan.',
  'Backup folder cleared': 'Carpeta de copias restablecida',
  ...
  'to install HipertroFit as a full-screen app.': 'para instalar HipertroFit como app a pantalla completa.',
  ...
  'Rest-timer alerts, even if HipertroFit is closed.': 'Avisos del temporizador de descanso, incluso con HipertroFit cerrado.',
  ...
  'Training strategy': 'Estrategia de entrenamiento',
  'Microcycle start': 'Comienzo del microciclo',
  'Sessions are counted from this day. The end of each microcycle follows from the count.': 'Las sesiones se cuentan desde este día. El final de cada microciclo sale de esa cuenta.',
  'Counted from your sequence': 'Contadas desde tu secuencia',
  'Set by the strategy': 'Según la estrategia',
  'Session {0} of {1}': 'Sesión {0} de {1}',
  'next in sequence': 'siguiente de la secuencia',
  'New microcycle — volume starts from zero.': 'Microciclo nuevo — el volumen empieza de cero.',
  'Deload': 'Descarga',
  'Deload microcycle': 'Microciclo de descarga',
  'Deload suggested': 'Descarga sugerida',
  'Time to deload': 'Toca descargar',
  'Deload next': 'Descargar el siguiente',
  'Not yet': 'Todavía no',
  'Asked again next microcycle.': 'Se vuelve a proponer en el próximo microciclo.',
  '{0} loading microcycles done. Make the next one a deload?': '{0} microciclos de carga completados. ¿Hacemos el siguiente de descarga?',
  '{0} loading microcycles in a row — {1} is the most before a deload.': '{0} microciclos de carga seguidos — {1} es el máximo antes de una descarga.',
  'This session comes down: less weight, fewer reps and fewer sets. Set how much — the app proposes, you decide.': 'Esta sesión baja: menos peso, menos repeticiones y menos series. Ajusta cuánto — la app propone, tú decides.',
  'It will not count toward progression, so nothing reads as a stall.': 'No cuenta para la progresión, así que nada se leerá como estancamiento.',
  'Reduction': 'Reducción',
  ...
  'in range': 'en rango',
  'over': 'alto',
  'Train a session to see your volume build up over the microcycle.': 'Entrena una sesión para ver el volumen acumularse a lo largo del microciclo.',
  'Programming': 'Programación',
  'Day sequence': 'Secuencia de días',
  'Use programming': 'Usar programación',
  'Overriding the weekly schedule': 'Sustituye al plan semanal',
  'Weekly schedule is in use': 'Se usa el plan semanal',
  'Lay your microcycle out as a repeating sequence of training and rest days. It projects onto the calendar and, while on, overrides the weekly schedule from the start date.': 'Distribuye tu microciclo como una secuencia repetida de días de entreno y descanso. Se proyecta en el calendario y, mientras está activa, sustituye al plan semanal desde la fecha de inicio.',
  'Add routines and rest days below to build the sequence.': 'Añade rutinas y días de descanso abajo para construir la secuencia.',
  'Deleted routine': 'Rutina eliminada',
  'Start date': 'Fecha de inicio',
  'Sessions per microcycle': 'Sesiones por microciclo',
  'The window the volume panel sums': 'La ventana que suma el panel de volumen',
  'Next 14 days': 'Próximos 14 días',
  'Open calendar': 'Abrir calendario',
  'Remove': 'Quitar',
  '{0}-day cycle · active': 'Ciclo de {0} días · activa',
  'Off — using weekly schedule': 'Desactivada — usando el plan semanal',
  'Overridden by the program while it is on.': 'La programación lo sustituye mientras está activa.',
  ...
  'A small file a friend imports into their own HipertroFit — routines only, none of your workouts or weigh-ins.': 'Un archivo pequeño que un amigo importa en su propio HipertroFit: solo rutinas, ninguno de tus entrenamientos ni pesajes.',
  ...
  'this isn’t an HipertroFit plan file': 'esto no es un archivo de plan de HipertroFit',
  'Shared routine': 'Rutina compartida',
  'Unknown exercise': 'Ejercicio desconocido',
  'Weekly Training Plan': 'Plan de entrenamiento semanal',
  'Made with HipertroFit': 'Hecho con HipertroFit',
  ...
  'Reload HipertroFit': 'Recargar HipertroFit',
  ...
  'Synced with your HipertroFit server.': 'Sincronizado con tu servidor de HipertroFit.',
  ...
  'Sync this device to your own self-hosted HipertroFit instead.': 'Sincroniza este dispositivo con tu propio HipertroFit self-hosted.',
  'Pair the mobile app': 'Emparejar la app móvil',
  'Connect the HipertroFit app on your phone to this account.': 'Conecta la app de HipertroFit en tu móvil a esta cuenta.',
  'Could not generate a code': 'No se pudo generar un código',
  'On the HipertroFit app, choose “Connect to my server”, then enter this address and the code below. It expires in 5 minutes.': 'En la app de HipertroFit, elige «Conectar a mi servidor», luego introduce esta dirección y el código de abajo. Caduca en 5 minutos.',
  ...
  'Open Settings → “Pair the mobile app” on the HipertroFit site you’re already signed into, then enter its address and the code shown there.': 'En Ajustes → «Emparejar la app móvil» del sitio de HipertroFit en el que ya has iniciado sesión, luego introduce su dirección y el código que aparece ahí.',
  'Server address (e.g. gym.example.com)': 'Dirección del servidor (p. ej. gym.example.com)',
  'Pairing code': 'Código de emparejamiento',
  'Connecting…': 'Conectando…',
  'Connect': 'Conectar',
  'How do you want to use HipertroFit?': '¿Cómo quieres usar HipertroFit?',
  'Use on this device': 'Usar en este dispositivo',
  'Local keeps everything on this phone. Connecting syncs to your own HipertroFit server instead — you can switch later in Settings.': 'Local mantiene todo en este teléfono. Conectar sincroniza con tu propio servidor de HipertroFit — puedes cambiarlo luego en Ajustes.',
  ...
  // Exercise-wide fields (lib/exercise-defaults.js)
  'Accept': 'Aceptar',
  'Added weight': 'Extra (kg)',
  'Progression rule': 'Regla de progresión',
  'Increment': 'Incremento',
  '{0}s': '{0}s',
  'Change this for every routine?': '¿Cambiarlo en todas las rutinas?',
  'These belong to the exercise, not to this routine — every routine that uses {0} will start from the new value.': 'Estos valores son del ejercicio, no de esta rutina: toda rutina que use {0} partirá del nuevo valor.',
  'Fields in this colour belong to the exercise: every routine that uses it starts from them, and changing one here changes it everywhere. The rest are this routine’s own.': 'Los campos de este color son del ejercicio: toda rutina que lo use parte de ellos, y cambiar uno aquí lo cambia en todas. El resto son propios de esta rutina.',
  // Exercise naming (manual rename + bilingual/translated-only style).
  'Exercise names': 'Nombres de los ejercicios',
  'Show the English term next to the translation, or the translation on its own. Any single exercise can also be renamed by hand from its detail page.': 'Muestra el término en inglés junto a la traducción, o solo la traducción. Cualquier ejercicio se puede renombrar a mano desde su ficha.',
  'With English': 'Con inglés',
  'Translated only': 'Solo español',
  'Rename this exercise': 'Renombrar este ejercicio',
  'Only the name changes — your routines, history and stats keep pointing at the same exercise. Leave it empty to go back to “{0}”.': 'Solo cambia el nombre: tus rutinas, tu historial y tus estadísticas siguen apuntando al mismo ejercicio. Déjalo vacío para volver a «{0}».',
  'Original name restored': 'Nombre original restaurado',
}
