...
export default {
  ...
  "This browser doesn't support passkeys — you can still use HipertroFit locally on this device.": 'Bu tarayıcı geçiş anahtarlarını desteklemiyor — yine de HipertroFit’i bu cihazda yerel olarak kullanabilirsin.',
  ...
  'to install HipertroFit as a full-screen app.': 'ile HipertroFit’i tam ekran uygulama olarak kurabilirsin.',
  ...
  'Rest-timer alerts, even if HipertroFit is closed.': 'HipertroFit kapalıyken bile dinlenme sayacı uyarıları.',
  ...
  'A small file a friend imports into their own HipertroFit — routines only, none of your workouts or weigh-ins.': 'Bir arkadaşının kendi HipertroFit\'ine aktardığı küçük bir dosya — yalnızca rutinler, antrenmanların veya tartıların değil.',
  ...
  'Your server': 'Sunucun',
  'Synced with your HipertroFit server.': 'HipertroFit sunucunla senkronize edildi.',
  ...
  'Sync this device to your own self-hosted HipertroFit instead.': "Bu cihazı bunun yerine kendi self-hosted HipertroFit'inle senkronize et.",
  'Pair the mobile app': 'Mobil uygulamayı eşleştir',
  'Connect the HipertroFit app on your phone to this account.': 'Telefonundaki HipertroFit uygulamasını bu hesaba bağla.',
  'Could not generate a code': 'Kod oluşturulamadı',
  'On the HipertroFit app, choose “Connect to my server”, then enter this address and the code below. It expires in 5 minutes.': 'HipertroFit uygulamasında “Sunucuma bağlan”ı seç, ardından bu adresi ve aşağıdaki kodu gir. 5 dakika içinde sona erer.',
  'Enter your server address and the code': 'Sunucu adresini ve kodu gir',
  'Connected': 'Bağlandı',
  'Could not connect': 'Bağlanılamadı',
  'Open Settings → “Pair the mobile app” on the HipertroFit site you’re already signed into, then enter its address and the code shown there.': 'Zaten oturum açtığın HipertroFit sitesinde Ayarlar → “Mobil uygulamayı eşleştir”i aç, ardından adresini ve orada gösterilen kodu gir.',
  'Server address (e.g. gym.example.com)': 'Sunucu adresi (ör. gym.example.com)',
  'Pairing code': 'Eşleştirme kodu',
  'Connecting…': 'Bağlanıyor…',
  'Connect': 'Bağlan',
  'How do you want to use HipertroFit?': "HipertroFit'i nasıl kullanmak istersin?",
  'Use on this device': 'Bu cihazda kullan',
  'Local keeps everything on this phone. Connecting syncs to your own HipertroFit server instead — you can switch later in Settings.': "Yerel, her şeyi bu telefonda tutar. Bağlanmak ise bunun yerine kendi HipertroFit sunucunla senkronize eder — bunu daha sonra Ayarlar'dan değiştirebilirsin.",
