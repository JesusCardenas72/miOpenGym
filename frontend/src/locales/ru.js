...
export default {
  ...
  "This browser doesn't support passkeys — you can still use HipertroFit locally on this device.": 'Этот браузер не поддерживает ключи доступа — но HipertroFit можно использовать локально на этом устройстве.',
  ...
  'to install HipertroFit as a full-screen app.': 'чтобы установить HipertroFit как полноэкранное приложение.',
  ...
  'Rest-timer alerts, even if HipertroFit is closed.': 'Оповещения таймера отдыха, даже если HipertroFit закрыт.',
  ...
  'A small file a friend imports into their own HipertroFit — routines only, none of your workouts or weigh-ins.': 'Небольшой файл, который друг импортирует в свой HipertroFit — только программы, без твоих тренировок и взвешиваний.',
  ...
  'Reload HipertroFit': 'Перезагрузить HipertroFit',
  ...
  'Synced with your HipertroFit server.': 'Синхронизировано с вашим сервером HipertroFit.',
  ...
  'Sync this device to your own self-hosted HipertroFit instead.': 'Синхронизировать это устройство с вашим собственным self-hosted HipertroFit.',
  'Pair the mobile app': 'Сопряжение мобильного приложения',
  'Connect the HipertroFit app on your phone to this account.': 'Подключите приложение HipertroFit на телефоне к этому аккаунту.',
  'Could not generate a code': 'Не удалось создать код',
  'On the HipertroFit app, choose “Connect to my server”, then enter this address and the code below. It expires in 5 minutes.': 'В приложении HipertroFit выберите «Подключиться к моему серверу», затем введите этот адрес и код ниже. Он действителен 5 минут.',
  'Enter your server address and the code': 'Введите адрес вашего сервера и код',
  'Connected': 'Подключено',
  'Could not connect': 'Не удалось подключиться',
  'Open Settings → “Pair the mobile app” on the HipertroFit site you’re already signed into, then enter its address and the code shown there.': 'В Настройках → «Сопряжение мобильного приложения» на сайте HipertroFit, где вы уже вошли, введите его адрес и показанный там код.',
  'Server address (e.g. gym.example.com)': 'Адрес сервера (например, gym.example.com)',
  'Pairing code': 'Код сопряжения',
  'Connecting…': 'Подключение…',
  'Connect': 'Подключить',
  'How do you want to use HipertroFit?': 'Как вы хотите использовать HipertroFit?',
  'Use on this device': 'Использовать на этом устройстве',
  'Local keeps everything on this phone. Connecting syncs to your own HipertroFit server instead — you can switch later in Settings.': 'Локальный режим хранит всё на этом телефоне. Подключение вместо этого синхронизирует данные с вашим сервером HipertroFit — вы сможете изменить это позже в Настройках.',
