...
export default {
  ...
  "This browser doesn't support passkeys — you can still use HipertroFit locally on this device.": 'Dieser Browser unterstützt keine Passkeys — du kannst HipertroFit trotzdem lokal auf diesem Gerät nutzen.',
  ...
  'to install HipertroFit as a full-screen app.': 'um HipertroFit als Vollbild-App zu installieren.',
  ...
  'Rest-timer alerts, even if HipertroFit is closed.': 'Pausen-Timer-Alarm, auch wenn HipertroFit geschlossen ist.',
  ...
  'A small file a friend imports into their own HipertroFit — routines only, none of your workouts or weigh-ins.': 'Eine kleine Datei, die ein Freund in sein eigenes HipertroFit importiert — nur Routinen, keine Workouts oder Wiegungen.',
  ...
  'this isn’t an HipertroFit plan file': 'das ist keine HipertroFit-Plandatei',
  'Shared routine': 'Geteilte Routine',
  'Unknown exercise': 'Unbekannte Übung',
  'Weekly Training Plan': 'Wochen-Trainingsplan',
  'Made with HipertroFit': 'Erstellt mit HipertroFit',
  ...
  'Reload HipertroFit': 'HipertroFit neu laden',
  ...
  'Synced with your HipertroFit server.': 'Mit deinem HipertroFit-Server synchronisiert.',
  'Disconnect': 'Trennen',
  ...
  'Sync this device to your own self-hosted HipertroFit instead.': 'Dieses Gerät stattdessen mit deinem eigenen self-hosted HipertroFit synchronisieren.',
  'Pair the mobile app': 'Mobile App koppeln',
  'Connect the HipertroFit app on your phone to this account.': 'Verbinde die HipertroFit-App auf deinem Handy mit diesem Konto.',
  'Could not generate a code': 'Code konnte nicht erstellt werden',
  'On the HipertroFit app, choose “Connect to my server”, then enter this address and the code below. It expires in 5 minutes.': 'Wähle in der HipertroFit-App „Mit meinem Server verbinden“, gib dann diese Adresse und den Code unten ein. Er läuft in 5 Minuten ab.',
  'Enter your server address and the code': 'Serveradresse und Code eingeben',
  'Connected': 'Verbunden',
  'Could not connect': 'Verbindung fehlgeschlagen',
  'Open Settings → “Pair the mobile app” on the HipertroFit site you’re already signed into, then enter its address and the code shown there.': 'Öffne auf der HipertroFit-Seite, bei der du bereits angemeldet bist, Einstellungen → „Mobile App koppeln“, und gib dann deren Adresse und den dort angezeigten Code ein.',
  'Server address (e.g. gym.example.com)': 'Serveradresse (z. B. gym.example.com)',
  'Pairing code': 'Kopplungscode',
  'Connecting…': 'Verbinde …',
  'Connect': 'Verbinden',
  'How do you want to use HipertroFit?': 'Wie möchtest du HipertroFit nutzen?',
  'Use on this device': 'Auf diesem Gerät nutzen',
  'Local keeps everything on this phone. Connecting syncs to your own HipertroFit server instead — you can switch later in Settings.': 'Lokal behält alles auf diesem Handy. Verbinden synchronisiert stattdessen mit deinem eigenen HipertroFit-Server — du kannst das später in den Einstellungen ändern.',
